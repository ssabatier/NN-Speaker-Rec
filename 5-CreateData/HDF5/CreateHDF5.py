...
This code read all the numpy files and create HDF5 file with TensorFlow format(num_samples,height,width,channel).
...
hdf5_file = h5py.File(choice_phase + '.hdf5', 'w')
